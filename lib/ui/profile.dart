...
class profile_page extends StatefulWidget {
  ...
  profile_page({Key key, this.username}):super(key:key);
                  ...
                  children: <Widget>[
                    Container(
                        ...
                        new CircleAvatar(
                          ...
                          child: new ClipOval(
                            child: new Image.file(File(profile_image), height: 120, width: 120, fit: BoxFit.cover,),
                          ),
                        )
                    ),
                    ...
                    new Row(
                      ...
                      children: <Widget>[
                        new Padding(padding: const EdgeInsets.fromLTRB(110, 0, 0, 0)),
                        new Text(
                          widget.username,
                          style: new TextStyle(
                              fontSize: 28,
                        ...
                        new IconButton(
                            ...
                            onPressed: (){
                              Navigator.push(
                                  context,
                                  new MaterialPageRoute(builder: (BuildContext context){
                                    return new edit_profile_page(username: widget.username,profile_image: profile_image,flag: flag,);
                                  })
                              );
                            },
